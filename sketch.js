...
function draw() {
  ...
  if (gameState === 1) {
    ...
    text("By This Time, 'THE MAN WITH MONEY' Or The Aristocrats Started Running The World. As They Were The 'ONLY HOPE', They Started Missing Their Power. ", 10, 450);
  ...
  if(gameState === 10){
    ...
    textSize(30);
    text("Credits -- KAR LLC And DK_STUDIOS",10,630);
  }
